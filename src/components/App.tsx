...
interface TimeRangeProps {
    ...
    showNow: boolean
    /**
     * Value on which labels sare shown
     */
    showMinutes?: number
}
...
class TimeRange extends React.Component<TimeRangeProps> {
    ...
    onUpdate = (newTime: ReadonlyArray<number>) => {
        ...
        if (disabledIntervals?.length) {
            const isValuesNotValid = disabledIntervals.some(({
                                                                 source,
                                                                 target
                                                             }) =>
    ...
    render() {
        const {
            ...
            showMinutes=defaultProps.showMinutes,
        } = this.props
        ...
        return (
            <TimeRangeContainer className={containerClassName}>
                ...
                >
                    <Rail>{({getRailProps}) => <SliderRail
                        getRailProps={getRailProps}/>}</Rail>
